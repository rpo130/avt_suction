...
class NerfNgp:
    def __init__(self, config=None):
        if config is None:
            config = '/home/amax_djh/code/ysl/instant-ngp/data/nerf/avt_data_20230210_1/transforms_ngp.json'
        self.config = config
    ...
    def nerf_camera(self, T_c2ws):
        ...
        snapfile = '/home/amax_djh/code/ysl/instant-ngp/data/nerf/avt_data_20230210_1/transforms_ngp_base.ingp'
